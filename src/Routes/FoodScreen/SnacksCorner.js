  ...
  const foodList = [
    {
      ...
      image: require('../../../assets/banners/snack-1.jpg'),
    },
    {
      id: 2,
      name: 'Food 2',
      description: 'Description for Food 2',
      image: require('../../../assets/banners/snack-2.jpg'),
    },
    {
      id: 3,
      name: 'Food 3',
      description: 'Description for Food 3',
      image: require('../../../assets/banners/snack-3.jpg'),
    },
  ...
  const foodlist1 = [
    {
      ...
      name: 'Foodggdsfg 1',
      description: 'Description for Food 1',
      image: require('../../../assets/banners/Nuts-1.jpg'),
    },
    {
      id: 2,
      name: 'Food 2',
      description: 'Description for Food 2',
      image: require('../../../assets/banners/Nuts-2.jpg'),
    },
    {
      id: 3,
      name: 'Food 3',
      description: 'Description for Food 3',
      image: require('../../../assets/banners/Nuts-3.jpg'),
    },
  ];
    ...
    <View style={{ flex: 1 }}>
      <ScrollView
        ...
        <TouchableOpacity
          ...
          <Text style={styles.reslistText}>Snacks (10)</Text>
          <AntDesign
        ...
        <TouchableOpacity
          ...
          <Text style={styles.reslistText}>Nut Seeds & Dry Fruits (10)</Text>
          <AntDesign
