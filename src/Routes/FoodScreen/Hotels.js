import {
  ...
  const Hotels = () => {
    ...
    const restaurantData = [
      ...
      {id: 2,
        name: 'Epar Bangla',
        image: require('../../../assets/banners/prawn.jpg'),
        rating: 4,
        reviews: 99,
        description: 'Try the authentic taste of East Bengal',
        distance: 'Staff Quater Rd 2.0km',},
        {id: 3,
          name: 'Hotel Habra Inn',
          image: require('../../../assets/banners/kabab.jpg'),
          rating: 4,
          reviews: 99,
          description: 'Want to try the flavour of BBQ',
          distance: 'Jessore Rd Habra 1.0km',},
        {id: 4,
          name: 'Aritra Hotel',
          image: require('../../../assets/banners/pulao.jpg'),
          rating: 4,
          reviews: 99,
          description: 'Pure Bengali Thali',
          distance: 'Parial Petrol Pump Habra 1.5km',},
        {id: 5,
          name: 'Floret',
          image: require('../../../assets/banners/biriyani-5.jpg'),
          rating: 4,
          reviews: 99,
          description: 'Explore the Hyderbadi Biriyani',
          distance: 'Joygachi Rd 2.5km',},
    ];
          ...
          <View key={restaurant.id} style={styles.main}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Card.Content style={styles.incard1}>
                ...
                <Text style={{fontSize:10}}>{restaurant.description}</Text>
